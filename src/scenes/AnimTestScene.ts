...
const CHAR_DEFS: CharDef[] = [
  ...
  {
    key: 'popo', label: 'Popo', scaleH: 1.0,
    anims: {
      idle:      { sheet: 'popo-idle-sheet',      start: 0, end: 35, fps: 10 },
      walk:      { sheet: 'popo-walk-sheet',      start: 0, end: 24, fps: 14 },
      punch:     { sheet: 'popo-punch-sheet',     start: 0, end: 24, fps: 22 },
      kick:      { sheet: 'popo-kick-sheet',      start: 0, end: 24, fps: 22 },
      hit:       { sheet: 'popo-hit-sheet',       start: 0, end: 35, fps: 22 },
      knockdown: { sheet: 'popo-knockdown-sheet', start: 0, end: 35, fps: 14 },
    },
  },
  {
    key: 'popo-son', label: 'Popo Son', scaleH: 1.0,
    anims: {
      idle:      { sheet: 'popo-son-idle-sheet',      start: 0, end: 24, fps: 10 },
      walk:      { sheet: 'popo-son-walk-sheet',      start: 0, end: 35, fps: 14 },
      punch:     { sheet: 'popo-son-punch-sheet',     start: 0, end: 24, fps: 22 },
      kick:      { sheet: 'popo-son-kick-sheet',      start: 0, end: 35, fps: 22 },
      hit:       { sheet: 'popo-son-hit-sheet',       start: 0, end: 35, fps: 22 },
      knockdown: { sheet: 'popo-son-knockdown-sheet', start: 0, end: 35, fps: 14 },
    },
  },
  {
    key: 'popo-coach', label: 'Popo Coach', scaleH: 1.0,
    anims: {
      idle:      { sheet: 'popo-coach-idle-sheet',      start: 0, end: 35, fps: 10 },
      walk:      { sheet: 'popo-coach-walk-sheet',      start: 0, end: 35, fps: 14 },
      punch:     { sheet: 'popo-coach-punch-sheet',     start: 0, end: 24, fps: 22 },
      kick:      { sheet: 'popo-coach-kick-sheet',      start: 0, end: 24, fps: 22 },
      hit:       { sheet: 'popo-coach-hit-sheet',       start: 0, end: 24, fps: 22 },
      knockdown: { sheet: 'popo-coach-knockdown-sheet', start: 0, end: 35, fps: 14 },
    },
  },
]
